...
parser.add_argument("--mode", default="train",
                    choices=["train", "test"], type=str, dest="mode")
parser.add_argument("--train_continue", default="on",
                    choices=["on", "off"], type=str, dest="train_continue")
...
parser.add_argument(
    "--data_dir", default="./datasets/person2electric", type=str, dest="data_dir")
...
parser.add_argument("--task", default="cyclegan",
                    choices=['cyclegan'], type=str, dest="task")
...
parser.add_argument("--network", default="CycleGAN",
                    choices=['DCGAN', 'pix2pix', 'CycleGAN'], type=str, dest="network")
parser.add_argument("--learning_type", default="plain",
                    choices=["plain", "residual"], type=str, dest="learning_type")
